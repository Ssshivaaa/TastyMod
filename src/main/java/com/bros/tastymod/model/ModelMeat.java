...
public class ModelMeat extends ModelBase {
    ...
    public BaseEntityMeat entityMeat;
...
//AnimationHandler.performAnimationInModel(parts, (EntityMeat)entityMeat);
//Render every non-child part
   ...
   // @Override
    public void setTileEntity(final BaseEntityMeat tileEntity) {
        this.entityMeat = tileEntity;
    }
}